...
// @ts-nocheck 
/*
 * This file exports the `Room_Details` model and its related types.
 *
...
export type GetRoom_DetailsAggregateType<T extends Room_DetailsAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateRoom_Details[P]>
    : Prisma.GetScalarType<T[P], AggregateRoom_Details[P]>
}
...
type GetRoom_DetailsGroupByPayload<T extends Room_DetailsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Room_DetailsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Room_DetailsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Room_DetailsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Room_DetailsGroupByOutputType[P]>
      }
    >
  >
...
export type Room_DetailsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface Room_DetailsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends Room_DetailsCountArgs>(
    args?: Prisma.Subset<T, Room_DetailsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Room_DetailsCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, Room_DetailsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRoom_DetailsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
